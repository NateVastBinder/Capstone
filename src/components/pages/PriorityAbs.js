    ...
    return (
        <div className="flex-col priority-width">
            ...
            <div className="center flex-col third-width">
                <button className="button" value='Upper Ab' onClick={submitHandler}>Upper Abs</button>
            </div>
            <div className="center flex-col third-width">
                <button className="button" value='Oblique' onClick={submitHandler}>Oblique</button>
            </div>
            <div className="center flex-col third-width">
                <button className="button" value='Lower Ab' onClick={submitHandler}>Lower Abs</button>
            </div>
            </div>
