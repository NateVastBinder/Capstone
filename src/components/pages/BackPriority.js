    ...
    return (
        <div className="flex-col full-width">
            ...
            <div className="center flex-col third-width">
                <button class="submitButton" value='Upper Back' onClick={submitHandler}>Upper Back</button>
            </div>
            <div className="center flex-col third-width">
                <button class="submitButton" value='Lats' onClick={submitHandler}>Lats</button>
            </div>
            <div className="center flex-col third-width">
                <button class="submitButton" value='Lower Back' onClick={submitHandler}>Lower Back</button>
            </div>
            </div>
