    ...
    return (
        <div className="flex-col priority-width">
            ...
            <div className="center flex-col third-width">
                <button className="button" value='Upper Chest' onClick={submitHandler}>Upper Chest</button>
            </div>
            <div className="center flex-col third-width">
                <button className="button" value='Mid Chest' onClick={submitHandler}>Mid Chest</button>
            </div>
            <div className="center flex-col third-width">
                <button className="button" value='Lower Chest' onClick={submitHandler}>Lower Chest</button>
            </div>
            </div>
