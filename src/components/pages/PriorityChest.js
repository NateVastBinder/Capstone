    ...
    return (
        <div className="flex-col full-width">
            ...
            <div className="center flex-col third-width">
                <button class="submitButton" value='Upper Chest' onClick={submitHandler}>Upper Chest</button>
            </div>
            <div className="center flex-col third-width">
                <button class="submitButton" value='Mid Chest' onClick={submitHandler}>Mid Chest</button>
            </div>
            <div className="center flex-col third-width">
                <button class="submitButton" value='Lower Chest' onClick={submitHandler}>Lower Chest</button>
            </div>
            </div>
